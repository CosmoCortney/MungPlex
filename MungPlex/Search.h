...
namespace MungPlex
{
    ...
    private:
        Search()
        {
            _searchValueTypes.emplace_back(std::pair<std::string, int>("Primitive", PRIMITIVE));
            _searchValueTypes.emplace_back(std::pair<std::string, int>("Array", ARRAY));
            _searchValueTypes.emplace_back(std::pair<std::string, int>("Text", TEXT));
            _searchValueTypes.emplace_back(std::pair<std::string, int>("Color", COLOR));

            _searchPrimitiveTypes.emplace_back(std::pair<std::string, int>("Int 8 (1 Byte)", INT8));
            _searchPrimitiveTypes.emplace_back(std::pair<std::string, int>("Int 16 (2 Bytes)", INT16));
            _searchPrimitiveTypes.emplace_back(std::pair<std::string, int>("Int 32 (4 Bytes)", INT32));
            _searchPrimitiveTypes.emplace_back(std::pair<std::string, int>("Int 64 (8 Bytes)", INT64));
            _searchArrayTypes = _searchPrimitiveTypes;
            _searchPrimitiveTypes.emplace_back(std::pair<std::string, int>("Float Single", FLOAT));
            _searchPrimitiveTypes.emplace_back(std::pair<std::string, int>("Float Double", DOUBLE));

            _searchTextTypes.emplace_back(std::pair<std::string, int>("UTF-8", MorphText::UTF8));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("UTF-16 Little Endian", MorphText::UTF16LE));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("UTF-16 Big Endian", MorphText::UTF16BE));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("UTF-32 Little Endian", MorphText::UTF32LE));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("UTF-32 Big Endian", MorphText::UTF32BE));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ASCII", MorphText::ASCII));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-1 (Latin-1)", MorphText::ISO_8859_1));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-2 (Latin-2)", MorphText::ISO_8859_2));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-3 (Latin-3)", MorphText::ISO_8859_3));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-4 (Latin-4)", MorphText::ISO_8859_4));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-5 (Cyrillic)", MorphText::ISO_8859_5));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-6 (Arabic)", MorphText::ISO_8859_6));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-7 (Greek)", MorphText::ISO_8859_7));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-8 (Hebrew)", MorphText::ISO_8859_8));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-9 (Turkish, Latin-5)", MorphText::ISO_8859_9));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-10 (Nordic, Latin-6)", MorphText::ISO_8859_10));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-11 (Thai)", MorphText::ISO_8859_11));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-13 (Baltic, Latin-7)", MorphText::ISO_8859_13));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-14 (Celtic, Latin-8)", MorphText::ISO_8859_14));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-15 (West European, Latin-9)", MorphText::ISO_8859_15));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("ISO-8859-16 (South-East European, Latin-10)", MorphText::ISO_8859_16));
            _searchTextTypes.emplace_back(std::pair<std::string, int>("Shift-Jis", MorphText::SHIFTJIS));

            _searchColorTypes.emplace_back(std::pair<std::string, int>("RGB 888 (3 Bytes)", LitColor::RGB888));
            _searchColorTypes.emplace_back(std::pair<std::string, int>("RGBA 888 (4 Bytes)", LitColor::RGBA8888));
            _searchColorTypes.emplace_back(std::pair<std::string, int>("RGBF (3 Floats)", LitColor::RGBF));
            _searchColorTypes.emplace_back(std::pair<std::string, int>("RGBAF (4 Floats)", LitColor::RGBAF));
            _searchColorTypes.emplace_back(std::pair<std::string, int>("RGB 565 (2 Bytes)", LitColor::RGB565));

            _searchConditionTypes.emplace_back(std::pair<std::string, int>("Equal (==)", Xertz::EQUAL));
            _searchConditionTypesText = _searchConditionTypes;
            _searchConditionTypes.emplace_back(std::pair<std::string, int>("Unequal (!=)", Xertz::UNEQUAL));
            _searchConditionTypesArray = _searchConditionTypes;
            _searchConditionTypes.emplace_back(std::pair<std::string, int>("Greater (>)", Xertz::GREATER));
            _searchConditionTypes.emplace_back(std::pair<std::string, int>("Greater or Equal (>=)", Xertz::GREATER_EQUAL));
            _searchConditionTypes.emplace_back(std::pair<std::string, int>("Lower (<)", Xertz::LOWER));
            _searchConditionTypes.emplace_back(std::pair<std::string, int>("Lower or Equal (<=)", Xertz::LOWER_EQUAL));
            _searchConditionTypesColor = _searchConditionTypes;
            _searchConditionTypes.emplace_back(std::pair<std::string, int>("Increased by", Xertz::INCREASED_BY));
            _searchConditionTypes.emplace_back(std::pair<std::string, int>("Decreased by", Xertz::DECREASED_BY));
            _searchConditionTypes.emplace_back(std::pair<std::string, int>("Value Between", Xertz::BETWEEN));
            _searchConditionTypes.emplace_back(std::pair<std::string, int>("Value Not Between", Xertz::NOT_BETWEEN));
            _searchConditionTypesFloat = _searchConditionTypes;
            _searchConditionTypes.emplace_back(std::pair<std::string, int>("AND (has all true bits)", Xertz::AND));
            _searchConditionTypes.emplace_back(std::pair<std::string, int>("OR (has at least 1 true bit)", Xertz::OR));

            _searchComparasionType.emplace_back(std::pair<std::string, int>("Unknown/Initial", Xertz::UNKNOWN));
            _searchComparasionType.emplace_back(std::pair<std::string, int>("Known Value", Xertz::KNOWN));
